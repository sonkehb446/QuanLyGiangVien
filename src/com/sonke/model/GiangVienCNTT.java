 ...
 * @author NHS
 */
public class GiangVienCNTT extends GiangVien {

    public GiangVienCNTT() {
    }

    public GiangVienCNTT(String MaGv, String HoTen, String MaKhoa, boolean GioiTinh, String DiaChi, float Hday, float TamUng) {
        super(MaGv, HoTen, MaKhoa, GioiTinh, DiaChi, Hday, TamUng);
    }

    public GiangVienCNTT(String MaGv, String HoTen, String MaKhoa, boolean GioiTinh, String DiaChi) {
        super(MaGv, HoTen, MaKhoa, GioiTinh, DiaChi);
    }

    public GiangVienCNTT(String MaGv, String HoTen, String MaKhoa, boolean GioiTinh, String DiaChi, float Hday, float TamUng, float Luong, float ThucLinh, String TinhTrang) {
