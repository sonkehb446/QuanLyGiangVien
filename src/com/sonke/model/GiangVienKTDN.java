 ...
 * @author NHS
 */
public class GiangVienKTDN extends GiangVien{

    public GiangVienKTDN() {
    }

    public GiangVienKTDN(String MaGv, String HoTen, String MaKhoa, boolean GioiTinh, String DiaChi, float Hday, float TamUng) {
        super(MaGv, HoTen, MaKhoa, GioiTinh, DiaChi, Hday, TamUng);
    }

    public GiangVienKTDN(String MaGv, String HoTen, String MaKhoa, boolean GioiTinh, String DiaChi) {
        super(MaGv, HoTen, MaKhoa, GioiTinh, DiaChi);
    }

    public GiangVienKTDN(String MaGv, String HoTen, String MaKhoa, boolean GioiTinh, String DiaChi, float Hday, float TamUng, float Luong, float ThucLinh, String TinhTrang) {
